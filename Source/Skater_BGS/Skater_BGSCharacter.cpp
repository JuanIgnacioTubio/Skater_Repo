...
ASkater_BGSCharacter::ASkater_BGSCharacter()
{
...
void ASkater_BGSCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ASkater_BGSCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
